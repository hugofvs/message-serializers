...
# source: message_formats/small_proto2.proto
...
User = _reflection.GeneratedProtocolMessageType('User', (_message.Message,), dict(
  DESCRIPTOR = _USER,
  __module__ = 'message_formats.small_proto2_pb2'
